...
import { groupShopsByPosition } from "./shopStacks";
...
describe("groupShopsByPosition — bucketing", () => {
    ...
    it("rounds fractional positions to bucket co-located shops", () => {
        const stacks = groupShopsByPosition([shop({ id: "a", positionX: 10.2, positionY: 5.0 }), shop({ id: "b", positionX: 9.8, positionY: 4.6 })], ctx);
