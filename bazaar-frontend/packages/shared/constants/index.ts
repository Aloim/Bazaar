...
export const SHARED_OBJECTS = {
  ...
  /** OwnerClaimBox shared object ID — V35 testnet DAppHub global singleton (DAppOwnerClaimBox). Now empty post-cap-routing PTB (DAppOwnerCap 0x4e9cbe48...4881 transferred to the deployer's own wallet). */
