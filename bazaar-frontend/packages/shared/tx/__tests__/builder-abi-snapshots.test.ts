...
const SHOP = ID(0xa1), SSU_GOV = ID(0xa2), TRIBE_GOV = ID(0xa3), MEMBERS = ID(0xa4),
      STORAGE = ID(0xa5), SSU = ID(0xa6), RECIPIENT_CHAR = ID(0xa7),
      LEDGER = ID(0xb1), VAULT = ID(0xb2), CONFIG = ID(0xb3), QUEUE = ID(0xb4),
      BOARD = ID(0xb5), LEADER_CAP = ID(0xc1), ADMIN_CAP = ID(0xc2),
      CHAR_CAP = ID(0xd1);
const CLOCK = "0x6";
// 32 base58 "1"s decode to 32 zero bytes — a structurally valid object digest.
const DIGEST = "11111111111111111111111111111111";

// ── Introspection helpers (SDK v1 getData shape, access kept tolerant) ────────
type AnyRec = Record<string, any>;

function describeCalls(tx: Transaction): Array<{ target: string; args: string[] }> {
...
function expectArgs(actual: string[], expected: string[]) {
